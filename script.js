...
async function runPrediction() {
    ...
    const oldMsg = resultDiv.querySelector('.save-confirmation');
    ...
    try {
        const response = await fetch('http://127.0.0.1:5000/predict', {
            ...
            body: JSON.stringify({ symptoms: activeTags, patient_id: patientId })
        });
        ...
        alert("Cannot connect to backend. Make sure python app.py is running on port 5000");
    } finally {
        btn.disabled = false;
